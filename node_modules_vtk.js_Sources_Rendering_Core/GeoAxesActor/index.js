...
function vtkGeoAxesActor(publicAPI, model) {
  // Set our className
  model.classHierarchy.push('vtkGeoAxesActor');
  ...
  publicAPI.update = () => {
    ...
    const zAxis = vtkArrowSource
      .newInstance(Object.assign({ direction: [0, 0, 1] }, model.iconfig))
      .getOutputData();
    centerDataSet(zAxis);
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  // Object methods
  vtkGeoAxesActor(publicAPI, model);
}

// ----------------------------------------------------------------------------

export const newInstance = macro.newInstance(extend, 'vtkGeoAxesActor');
